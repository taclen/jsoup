        ...
        try {
            ...
            for (Element element: zjs) {
                ...
                result = result.replaceAll("-->> 本章未完，点击下一页继续阅读","").replaceAll("> 本章未完，点击下一页继续阅读\n" +
                        ...
                        "]","").replaceAll("\\+激|情小说 http://www.hxiaoshuo.net/duanpian/1.html","")
                .replaceAll("\\|乳\\|","乳").replaceAll("<\n" +
                                "br> ", "").replaceAll("chu女","处女")
                .replaceAll("\\*\\*的\\*\\*","高潮的肉体").replaceAll("\\*\\*的余韵","高潮的余韵")
                .replaceAll("\\*\\*声","啪啪声").replaceAll("巫山\\*\\*","巫山云雨")
                        .replaceAll("达到\\*\\*","达到高潮")
                .replaceAll("的\\*\\*下","的抽插下")
                .replaceAll("金枪的\\*\\*","金枪的抽插")
                .replaceAll("金枪","肉棒")
                .replaceAll("\\*\\*了","抽插了")
                .replaceAll("\\*\\*颤抖","乳房颤抖")
                .replaceAll("\\*\\*亢奋","肉体亢奋")
                .replaceAll("修长的\\*\\*","修长的玉腿")
                .replaceAll("\\*\\*后的","高潮后的")
                .replaceAll("抖动的\\*\\*","抖动的乳房")
                .replaceAll("李浩轩的\\*\\*","李浩轩的抽插")
                .replaceAll("\\*\\*裸","赤裸")
                .replaceAll("\\*\\*蚀骨","销魂蚀骨")
                .replaceAll("柔肌滑肤的\\*\\*","柔肌滑肤的肉体")
                .replaceAll("\\*\\*勃发","肉欲勃发")
                .replaceAll("乳白色的\\*\\*","乳白色的淫液")
                .replaceAll("达到了\\*\\*","达到了高潮")
                .replaceAll("\\*\\*时","高潮时")
                .replaceAll("\\*\\*罩","乳罩")
                .replaceAll("椒\\*\\*","椒乳")
                .replaceAll("\\*\\*的火苗","欲望的火苗")
                .replaceAll("压抑着自己的\\*\\*","压抑着自己的欲望")
                .replaceAll("一丝不挂的\\*\\*","一丝不挂的肉体")
                .replaceAll("丰腴\\*\\*","丰腴肉体")
                .replaceAll("\\*\\*的亮光","淫靡的亮光")
                .replaceAll("\\*\\*横陈","玉体横陈")
                .replaceAll("健美的\\*\\*","健美的玉腿")
                .replaceAll("为我\\*\\*","为我口交")
                .replaceAll("\\*\\*正酣","激战正酣")
//                .replaceAll("","")
//                .replaceAll("","")
